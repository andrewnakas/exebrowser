// Pages Function middleware for the OpenTTD WASM bundle.
//
// Why this exists: the site-wide _headers catch-all sets
//   Cross-Origin-Opener-Policy: same-origin
// (needed by the Boxedwine apps for SharedArrayBuffer). OpenTTD uses NO
// SharedArrayBuffer / threads and is loaded in an <iframe> from
// /run/openttd/. COOP:same-origin severs the parent<->iframe browsing
