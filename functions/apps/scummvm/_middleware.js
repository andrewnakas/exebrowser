// Pages Function middleware for the ScummVM WASM bundle.
//
// Why this exists: the site-wide _headers catch-all sets
//   Cross-Origin-Opener-Policy: same-origin
// (needed by the Boxedwine apps for SharedArrayBuffer). ScummVM uses NO
// SharedArrayBuffer / threads and is loaded in an <iframe> from
// /run/beneath-a-steel-sky/. COOP:same-origin severs the parent<->iframe browsing
